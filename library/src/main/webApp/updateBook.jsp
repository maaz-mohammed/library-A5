              ...
              <form action="/update" method="post" id="enrollment-form" >
                <div class="row mb-3">
                  ...
                  <div class="col-9 col-md-8 text-center">
                    <input type="text" readonly class="form-input m-0 w-100 rounded border-1" value="${bookObj.getBookCode()}" name="bookId" required/>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-3 col-md-4 text-start">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-9 col-md-8 text-center">
                   <input class="form-select m-0 w-100 rounded border-1" name="authorName" id="author" aria-label="Default select example" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-9 col-md-8 text-center">
                      <input type="date" class="form-input m-0 w-100 rounded border-1" value="${bookObj.getDate()}" name="date" required/>
                  </div>
                </div>
